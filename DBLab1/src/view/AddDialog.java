...
public class AddDialog extends Dialog<AddInfo> {
    ...
    AddDialog() {
        ...
        this.setResultConverter(new Callback<ButtonType, AddInfo>() {
            @Override
            public AddInfo call(ButtonType b) {
                if (b == buttonTypeOk) {
...
class AddInfo {
    ...
    AddInfo(String title, String releaseDate, String length, String numberOfSongs,
