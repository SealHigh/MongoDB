...
public class AddReviewDialog extends Dialog<ReviewInfo> {
    ...
    AddReviewDialog() {
        ...
        this.setResultConverter(new Callback<ButtonType, ReviewInfo>() {
            @Override
            public ReviewInfo call(ButtonType b) {
                if (b == buttonTypeOk) {
                    ...
                    AddReviewDialog.this.clearFields();
                    return reviewInfo;
                }
                return null;
            }
...
class ReviewInfo {
    ...
    ReviewInfo(String userName, String password) {
