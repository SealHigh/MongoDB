...
public class QueryMovieDialog extends Dialog<QueryMovieInfo> {
    ...
    QueryMovieDialog() {
        ...
        */
        ...
        this.setResultConverter(new Callback<ButtonType, QueryMovieInfo>() {
            @Override
            public QueryMovieInfo call(ButtonType b) {
                if (b == buttonTypeOk) {

                    QueryMovieInfo qInfo = new QueryMovieInfo(
                            userInput.getText(), searchComboBox.getValue());
                    QueryMovieDialog.this.clearFields();
                    return qInfo;
                }
                return null;
            }
        ...
        okButton.addEventFilter(
            ...
            public void handle(ActionEvent ae) {
                ...
                /*String queryErrors = con.validateQueryMovieDialogInput();
